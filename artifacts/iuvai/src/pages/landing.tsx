          ...
          <div className="mx-auto flex min-h-[calc(100vh-68px)] max-w-7xl items-center px-6 py-20 sm:px-8 lg:px-8 lg:py-24">
            <div className="grid w-full items-center gap-16 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <div className="relative mx-auto hidden h-[470px] w-[470px] lg:block">
                ...
                {/* Labels */}
                <div className="absolute left-[4%] top-[29%] text-[10px] uppercase tracking-[0.2em] text-muted-foreground/60">
                  Humanity
                </div>
                <div className="absolute right-[3%] top-[29%] text-[10px] uppercase tracking-[0.2em] text-muted-foreground/60">
                  Intelligence
                </div>
                <div className="absolute bottom-[5%] left-1/2 -translate-x-1/2 text-center">
                  <div className="text-[9px] uppercase tracking-[0.3em] text-primary/70">
