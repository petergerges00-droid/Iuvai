      ...
      <div className="space-y-6">
          ...
          <div className="relative p-6 sm:p-8">
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="flex shrink-0 gap-2">
                ...
                >
                  <Link
                    href={`/company-dashboard/projects/${project.id}/edit`}
                  >
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <ProjectStat
            ...
            value={
              project.experts_needed != null
                ? String(project.experts_needed)
                : 'Not specified'
            }
          />
          <ProjectStat
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <section className="lg:col-span-2">
            <div className="mb-4">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                The requirements below will be used to
                identify and match suitable experts.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-border/60 bg-card/40">
              ...
              <div className="border-t border-border/60 p-5">
                <div className="flex items-start gap-2 text-xs leading-5 text-muted-foreground">
                  ...
                  <span>
                    Project information is visible only
                    to authorized members of your
                    organization.
                  </span>
                </div>
              </div>
        ...
        <section className="rounded-2xl border border-border/60 bg-card/40">
          <div className="flex flex-col gap-4 border-b border-border/60 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Applications from experts for this
                project will appear here.
              </p>
            </div>
            <Badge
              variant="outline"
              className="w-fit border-border/60 bg-muted/20 text-[9px] uppercase tracking-wider"
            >
              0 applications
            </Badge>
          </div>
          <div className="p-8 text-center sm:p-10">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-muted-foreground">
              Once your project is open for expert
              applications, submissions and candidate
              profiles will appear in this section.
            </p>
            {project.status === 'open' && (
              <Button
                className="mt-5"
                asChild
              >
                <Link href="/company/find-experts">
