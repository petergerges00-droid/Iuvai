...
This is the same logo used on the landing page:
    ...
    >
      ...
      <div
        className="
          ...
          group-hover:shadow-[0_0_18px_rgba(99,102,241,0.35)]
        "
      />
      ...
      <div
        className="
          ...
          group-hover:shadow-[0_0_18px_rgba(99,102,241,0.25)]
        "
      />
